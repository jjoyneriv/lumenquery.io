...
const SITEMAP_URLS = [
  ...
  '/blog/track-live-stellar-transactions-real-time',
  '/blog/building-blockchain-explorer-stellar-core-data',
  '/blog/stellar-smart-contract-events-soroban-developers',
  '/blog/api-rate-limits-blockchain-apps-production',
  '/blog/natural-language-search-stellar-blockchain-data',
