      ...
      <div className={`flex flex-col items-center gap-3 ${className}`}>
        <div className="text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 px-4 py-2 bg-[#2855FF] text-white rounded-lg hover:bg-[#1e44cc] transition-colors"
          >
  ...
  return (
    <div className={`flex flex-col items-center gap-3 ${className}`}>
      <button
        ...
        disabled={loading}
        className="inline-flex items-center gap-2 px-6 py-3 bg-[#2855FF] text-white rounded-lg hover:bg-[#1e44cc] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path
            strokeLinecap="round"
