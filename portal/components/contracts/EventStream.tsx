  ...
  if (events.length === 0) {
    return (
      <div className="bg-[#262932] border border-white/10 rounded-lg p-8 text-center">
        ...
        <p className="text-gray-400">No events found for this contract</p>
      </div>
    );
  }
      ...
      <div className="bg-[#262932] border border-white/10 rounded-lg overflow-hidden">
        <div className="divide-y divide-[#E6E7E9]">
          {events.map((event) => {
            ...
            return (
              <div key={event.id} className="p-4 hover:bg-[#1D1E26] transition-colors">
                  ...
                  <div className="flex-1 min-w-0">
                      ...
                      <div className="mb-2">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {(Array.isArray(event.topics) ? event.topics : []).map((topic: string, i: number) => (
                            <code
                              key={i}
                              className="text-xs font-mono bg-[#1D1E26] px-2 py-0.5 rounded"
                            >
                    ...
                    {event.data && (
                      <div>
                        ...
                        <pre className="text-xs font-mono bg-[#1D1E26] p-2 rounded overflow-x-auto max-h-24">
