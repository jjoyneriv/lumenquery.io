...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      ...
      <main>
        {/* Hero */}
        <header className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#0D0D0D]">
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex flex-wrap justify-center gap-2 sm:gap-3 mb-4 sm:mb-6">
            <span className="px-3 py-1 rounded-full bg-[#2855FF]/10 border border-[#2855FF]/20 text-[#2855FF] text-xs sm:text-sm font-medium">Horizon API</span>
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
            ...
            <Link href="/docs" className="px-6 sm:px-8 py-3 sm:py-4 rounded-lg border-2 border-white/20 hover:border-[#2855FF] text-white hover:text-[#2855FF] font-semibold text-base sm:text-lg transition-colors text-center">
              View Documentation
            </Link>
          </div>
        ...
        {/* Code Example */}
        <section className="py-10 sm:py-16 px-4 sm:px-6 bg-[#0D0D0D]" aria-labelledby="code-examples-heading">
...

{
  "result": {
    "sequence": 60924672
        ...
        {/* Features */}
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#111111]" aria-labelledby="features-heading">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10">
              <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-[#2855FF]/10 flex items-center justify-center text-xl sm:text-2xl mb-4 sm:mb-6">
                ⚡
              </div>
            ...
            <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10 sm:col-span-2 md:col-span-1">
              <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-lg sm:rounded-xl bg-[#2855FF]/10 flex items-center justify-center text-xl sm:text-2xl mb-4 sm:mb-6">
                📈
              </div>
        ...
        {/* Pricing */}
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#0D0D0D]" aria-labelledby="pricing-heading">
          <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            ...
            <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-white/10 bg-white">
              ...
              <Link href="/auth/signup" className="block text-center px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg border border-white/10 hover:border-[#2855FF] text-white hover:text-[#2855FF] font-medium transition-colors text-sm sm:text-base">
                Get Started
              </Link>
            </div>
            ...
            <div className="p-5 sm:p-6 md:p-8 rounded-xl sm:rounded-2xl border border-white/10 bg-white">
              ...
              <a href="mailto:sales@lumenquery.io" className="block text-center px-4 sm:px-6 py-2.5 sm:py-3 rounded-lg border border-white/10 hover:border-[#2855FF] text-white hover:text-[#2855FF] font-medium transition-colors text-sm sm:text-base">
                Contact Sales
              </a>
            </div>
          </div>
        ...
        {/* Developer Guides */}
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#0D0D0D]" aria-labelledby="guides-heading">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <Link href="/guides/stellar-rpc-guide" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all group">
                <div className="w-10 h-10 rounded-lg bg-[#2855FF]/10 flex items-center justify-center mb-3 group-hover:bg-[rgba(40,85,255,0.2)] transition-colors">
              ...
              <Link href="/guides/stellar-api-tutorial" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all group">
              ...
              <Link href="/guides/horizon-vs-rpc-vs-indexers" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all group">
              ...
              <Link href="/guides/lumenquery-tutorial" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all group">
                <div className="w-10 h-10 rounded-lg bg-[#2855FF]/10 flex items-center justify-center mb-3 group-hover:bg-[rgba(40,85,255,0.2)] transition-colors">
        ...
        <section className="py-12 sm:py-16 md:py-24 px-4 sm:px-6 bg-[#111111]" aria-labelledby="blog-heading">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <Link href="/blog/stellar-foundation-real-world-assets" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 rounded-full bg-[#2855FF]/10 text-[#2855FF] text-xs font-medium">Industry Insights</span>
                </div>
              ...
              <Link href="/blog/stellar-foundation-roadmap-2026" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 rounded-full bg-[#2855FF]/10 text-[#2855FF] text-xs font-medium">Industry Insights</span>
                </div>
              ...
              <Link href="/blog/using-stellar-rpc-access-blockchain-data" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 rounded-full bg-[#2855FF]/10 text-[#2855FF] text-xs font-medium">Developer Guide</span>
                </div>
              ...
              <Link href="/blog/stellar-expanding-developer-ecosystem" className="p-5 sm:p-6 rounded-xl sm:rounded-2xl bg-[#1A1A1A] border border-white/10 hover:border-[#2855FF] hover:shadow-md transition-all">
                <div className="flex items-center gap-2 mb-3">
                  <span className="px-2 py-0.5 rounded-full bg-[#2855FF]/10 text-[#2855FF] text-xs font-medium">Industry Insights</span>
                </div>
            ...
            <div className="text-center mt-6 sm:mt-8">
              <Link href="/blog" className="inline-block px-6 py-3 rounded-lg border-2 border-white/10 hover:border-[#2855FF] text-white hover:text-[#2855FF] font-medium text-sm sm:text-base transition-colors">
                View All Articles
              </Link>
            </div>
          </div>
