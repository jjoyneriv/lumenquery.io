...
function ResetPasswordForm() {
  ...
  if (validating) {
    return (
      <main className="min-h-screen bg-[#1D1E26] flex items-center justify-center px-4 py-8">
    ...
    return (
      <main className="min-h-screen bg-[#1D1E26] flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-400 mb-6">No reset token was provided. Please request a new password reset.</p>
          <Link
    ...
    return (
      <main className="min-h-screen bg-[#1D1E26] flex items-center justify-center px-4 py-8">
        <div className="w-full max-w-md text-center">
          ...
          <p className="text-gray-400 mb-6">{error || 'This password reset link has expired or is invalid.'}</p>
          <Link
            href="/auth/forgot-password"
            className="inline-block px-6 py-3 rounded-lg bg-[#7366FF] hover:bg-[#5A4FCF] text-white font-semibold transition-colors"
          >
      ...
      <div className="w-full max-w-md">
        ...
        <section className="bg-[#262932] rounded-xl sm:rounded-2xl p-5 sm:p-8 shadow-sm border border-white/10">
          <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-white mb-1.5 sm:mb-2">
