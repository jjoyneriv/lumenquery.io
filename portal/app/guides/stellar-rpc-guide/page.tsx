    ...
    "method": "getHealth"
          ...
          <div className="overflow-x-auto my-6">
            <table className="w-full text-sm border border-white/10 rounded-lg overflow-hidden">
              ...
              <tbody>
                <tr className="border-b border-white/10"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getHealth</td><td className="py-3 px-4 text-gray-400">Server status</td><td className="py-3 px-4 text-gray-400">Health checks, monitoring</td></tr>
                <tr className="border-b border-white/10 bg-white/5/50"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getLatestLedger</td><td className="py-3 px-4 text-gray-400">Current ledger</td><td className="py-3 px-4 text-gray-400">Dashboard displays</td></tr>
                <tr className="border-b border-white/10"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getLedgerEntries</td><td className="py-3 px-4 text-gray-400">Read state</td><td className="py-3 px-4 text-gray-400">Contract storage queries</td></tr>
                <tr className="border-b border-white/10 bg-white/5/50"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">simulateTransaction</td><td className="py-3 px-4 text-gray-400">Test transactions</td><td className="py-3 px-4 text-gray-400">Fee estimation, debugging</td></tr>
                <tr className="border-b border-white/10"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">sendTransaction</td><td className="py-3 px-4 text-gray-400">Submit transactions</td><td className="py-3 px-4 text-gray-400">Payments, contract calls</td></tr>
                <tr className="border-b border-white/10 bg-white/5/50"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getTransaction</td><td className="py-3 px-4 text-gray-400">Transaction status</td><td className="py-3 px-4 text-gray-400">Confirmation polling</td></tr>
                <tr className="border-b border-white/10"><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getEvents</td><td className="py-3 px-4 text-gray-400">Contract events</td><td className="py-3 px-4 text-gray-400">Event monitoring</td></tr>
                <tr><td className="py-3 px-4 font-mono text-[#2855FF] text-xs">getFeeStats</td><td className="py-3 px-4 text-gray-400">Fee statistics</td><td className="py-3 px-4 text-gray-400">Transaction pricing</td></tr>
              </tbody>
            </table>
          </div>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            You can see these methods in action on our <Link href="/analytics" className="text-[#2855FF] hover:underline">Stellar Network Analytics Dashboard</Link>, which uses <code className="px-2 py-1 rounded bg-white/5 text-[#2855FF] text-xs border border-white/10">getLatestLedger</code> and Horizon endpoints to display live network metrics.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold mt-10 mb-4">Querying Smart Contracts with the Stellar Smart Contract API</h2>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            Soroban smart contracts store their state on-ledger, and the <strong className="font-semibold text-white">Stellar smart contract API</strong> methods let you read this data directly. The <code className="px-2 py-1 rounded bg-white/5 text-[#2855FF] text-xs border border-white/10">getLedgerEntries</code> method is the primary tool for querying contract storage.
          </p>
...
console.log('Contract state:', entries);`}</code></pre>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            The <strong className="font-semibold text-white">Stellar transaction query API</strong> includes <code className="px-2 py-1 rounded bg-white/5 text-[#2855FF] text-xs border border-white/10">simulateTransaction</code>, which is essential for any application that submits transactions. It previews the result, estimates resource usage, and calculates fees—all without spending XLM. This is the same pattern used in LumenQuery&apos;s <Link href="/contracts/deploy" className="text-[#2855FF] hover:underline">contract deployment feature</Link>.
          </p>
  ...
  // Safe to sign and submit
          ...
          <div className="space-y-4 my-6">
            ...
            <div className="p-4 rounded-xl border border-white/10">
              ...
              <p className="text-sm text-gray-400">Implement exponential backoff on 429 responses. See our <Link href="/docs" className="text-[#2855FF] hover:underline">API docs</Link> for rate limit tiers.</p>
            </div>
            <div className="p-4 rounded-xl border border-white/10">
              <h4 className="font-bold text-sm mb-1">4. Use managed infrastructure</h4>
              <p className="text-sm text-gray-400">Running your own RPC node requires significant ops overhead. <Link href="/blog/best-stellar-api-providers-2026" className="text-[#2855FF] hover:underline">Compare Stellar API providers</Link> to find the best fit.</p>
            </div>
          </div>
          ...
          <div className="space-y-3 my-6">
            <p className="text-sm text-gray-400"><strong className="text-white">Step 1:</strong> <Link href="/auth/signup" className="text-[#2855FF] hover:underline">Create a free LumenQuery account</Link></p>
            <p className="text-sm text-gray-400"><strong className="text-white">Step 2:</strong> Get your API key from the <Link href="/dashboard" className="text-[#2855FF] hover:underline">Dashboard</Link></p>
            <p className="text-sm text-gray-400"><strong className="text-white">Step 3:</strong> Follow our <Link href="/guides/stellar-api-tutorial" className="text-[#2855FF] hover:underline">Stellar API Tutorial</Link> for step-by-step instructions</p>
            <p className="text-sm text-gray-400"><strong className="text-white">Step 4:</strong> Explore live data with the <Link href="/query" className="text-[#2855FF] hover:underline">Natural Language Query Interface</Link></p>
          </div>
