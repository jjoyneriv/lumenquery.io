  ...
  console.table(data.recentTransactions);
          ...
          <div className="my-8 p-5 sm:p-8 rounded-xl bg-[#F5F6F7] border border-[#E6E7E9]">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/guides/horizon-vs-rpc-vs-indexers" className="text-[#2855FF] hover:underline">Horizon vs RPC vs Indexers</Link> — Choose the right data access pattern</li>
              <li><Link href="/guides/lumenquery-tutorial" className="text-[#2855FF] hover:underline">LumenQuery Tutorial</Link> — Explore all platform features</li>
              <li><Link href="/blog/build-stellar-blockchain-explorer-horizon-api" className="text-[#2855FF] hover:underline">Build a Stellar Blockchain Explorer</Link> — Full Next.js project tutorial</li>
              ...
              <li><Link href="/docs" className="text-[#2855FF] hover:underline">API Documentation</Link> — Full endpoint reference</li>
              <li><Link href="/docs/portfolio" className="text-[#2855FF] hover:underline">Portfolio Intelligence Docs</Link> — Build portfolio tracking apps</li>
            </ul>
          </div>
        </section>
