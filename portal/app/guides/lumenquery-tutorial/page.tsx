      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16">
        ...
        <header className="mb-8 sm:mb-12">
          <div className="flex items-center gap-2 mb-4">
            <span className="px-3 py-1 rounded-full bg-[rgba(40,85,255,0.1)] text-[#7366FF] text-xs font-medium">Platform Tutorial</span>
          </div>
        ...
        <section className="prose prose-gray max-w-none" aria-label="Tutorial content">
          ...
          <div className="my-8 p-4 sm:p-6 rounded-xl bg-white/5 border border-white/10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm text-gray-400">
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">1.</span> Account Setup & API Keys</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">2.</span> Natural Language Query</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">3.</span> Network Analytics Dashboard</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">4.</span> Smart Contract Explorer</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">5.</span> Live Transaction Viewer</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">6.</span> Portfolio Intelligence</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">7.</span> API Integration</div>
              <div className="flex items-center gap-2"><span className="text-[#7366FF]">8.</span> Horizon API & Stellar RPC</div>
            </div>
          </div>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            <Link href="/auth/signup" className="text-[#7366FF] hover:underline">Create a free account</Link> to get started. The free tier includes 10,000 API requests per month and full access to all dashboard features.
          </p>
...
curl -H "X-API-Key: $LUMENQUERY_API_KEY" \\
  https://api.lumenquery.io/ledgers?limit=1`}</code></pre>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            The <Link href="/query" className="text-[#7366FF] hover:underline">Natural Language Query Interface</Link> lets you explore the <strong className="font-semibold text-white">Stellar transaction query API</strong> without writing code. Just type your question in plain English:
          </p>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            The <Link href="/analytics" className="text-[#7366FF] hover:underline">Analytics Dashboard</Link> provides real-time <strong className="font-semibold text-white">Stellar network analytics tools</strong> with no authentication required. Monitor:
          </p>

          <ul className="space-y-2 my-4">
            <li className="text-gray-400 ml-4 list-disc text-sm sm:text-base"><Link href="/analytics/network" className="text-[#7366FF] hover:underline">Network Overview</Link> — Ledger progression, TPS, success rates, base fees</li>
            <li className="text-gray-400 ml-4 list-disc text-sm sm:text-base"><Link href="/analytics/tokens" className="text-[#7366FF] hover:underline">Token Analytics</Link> — Asset velocity, whale movements, payment activity charts</li>
            <li className="text-gray-400 ml-4 list-disc text-sm sm:text-base"><Link href="/analytics/contracts" className="text-[#7366FF] hover:underline">Contract Analytics</Link> — Soroban invocation counts, gas usage, success rates</li>
          </ul>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            Read the <Link href="/docs/analytics" className="text-[#7366FF] hover:underline">Analytics documentation</Link> for details on data sources, refresh rates, and understanding stroops.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold mt-10 mb-4">4. Smart Contract Explorer (Soroban Pro)</h2>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            The <Link href="/contracts" className="text-[#7366FF] hover:underline">Smart Contract Explorer</Link> decodes Soroban contract data into human-readable format:
          </p>
          ...
          <ul className="space-y-2 my-4">
            ...
            <li className="text-gray-400 ml-4 list-disc text-sm sm:text-base"><strong className="text-white">Contract Deployment</strong> — <Link href="/contracts/deploy" className="text-[#7366FF] hover:underline">Deploy contracts</Link> directly from the browser with Freighter wallet</li>
          </ul>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            See the <Link href="/docs/contracts" className="text-[#7366FF] hover:underline">contracts documentation</Link> for the full feature reference.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold mt-10 mb-4">5. Live Transaction Viewer</h2>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            The <Link href="/dashboard/transactions" className="text-[#7366FF] hover:underline">Live Transaction Viewer</Link> streams decoded transactions in real time via Server-Sent Events. Operations are translated into plain English (e.g., &quot;Payment of 100 XLM from GAXJ... to GBCD...&quot;). This is one of LumenQuery&apos;s most powerful <strong className="font-semibold text-white">Stellar network analytics tools</strong> for monitoring network activity.
          </p>

          <h2 className="text-xl sm:text-2xl font-bold mt-10 mb-4">6. Portfolio Intelligence</h2>

          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            <Link href="/portfolio" className="text-[#7366FF] hover:underline">Portfolio Intelligence</Link> lets you aggregate multiple Stellar accounts, track P&amp;L with FIFO cost basis, assess trustline risk, and monitor Soroban DeFi positions. See the <Link href="/docs/portfolio" className="text-[#7366FF] hover:underline">Portfolio documentation</Link> for details.
          </p>
...
# thresholds, signers, data`}</code></pre>
  ...
  "id":1}'`}</code></pre>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            For a detailed comparison, read our <Link href="/guides/horizon-vs-rpc-vs-indexers" className="text-[#7366FF] hover:underline">Horizon vs RPC vs Indexers comparison</Link>. For RPC specifics, see our <Link href="/guides/stellar-rpc-guide" className="text-[#7366FF] hover:underline">Stellar RPC guide</Link>. For a hands-on coding tutorial, follow our <Link href="/guides/stellar-api-tutorial" className="text-[#7366FF] hover:underline">Stellar API Tutorial</Link>.
          </p>
          ...
          <p className="text-gray-400 leading-relaxed mb-4 text-sm sm:text-base">
            For self-hosted infrastructure monitoring, our blog post on <Link href="/blog/monitor-stellar-validator-horizon-node" className="text-[#7366FF] hover:underline">monitoring Stellar validators and Horizon nodes</Link> covers Prometheus and Grafana setup in detail.
          </p>
          ...
          <div className="my-8 p-5 sm:p-8 rounded-xl bg-white/5 border border-white/10">
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/docs" className="text-[#7366FF] hover:underline">API Documentation</Link> — Full Horizon and RPC endpoint reference</li>
              <li><Link href="/blog/getting-started-with-lumenquery" className="text-[#7366FF] hover:underline">Getting Started with LumenQuery</Link> — Original quick-start guide</li>
              ...
              <li><Link href="/blog/using-stellar-rpc-access-blockchain-data" className="text-[#7366FF] hover:underline">Using Stellar RPC to Access Blockchain Data</Link></li>
              <li><Link href="/blog/stellar-api-use-cases-for-fintech" className="text-[#7366FF] hover:underline">5 Powerful Use Cases for the Stellar Horizon API</Link></li>
              <li><Link href="/pricing" className="text-[#7366FF] hover:underline">Pricing Plans</Link> — Free, Starter, Professional, Enterprise</li>
            </ul>
          </div>
        </section>
