...
const intelligenceNavItems = [
  ...
  { href: '/intelligence/stream', label: 'Live Stream' },
  { href: '/intelligence/accounts', label: 'Accounts' },
  { href: '/intelligence/watchlists', label: 'Watchlists' },
  { href: '/intelligence/alerts', label: 'Alerts' },
  { href: '/intelligence/trustlines', label: 'Trustlines' },
  { href: '/intelligence/contracts', label: 'Contracts' },
];

export default function IntelligenceLayoutClient({
  children,
}: {
  ...
  return (
    <div className="min-h-screen bg-[#111111] text-white">
      ...
      <header className="bg-[#0D0D0D] border-b border-white/10">
        ...
        {/* Product Navigation */}
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2 flex items-center gap-1 sm:gap-2 overflow-x-auto border-t border-white/10">
