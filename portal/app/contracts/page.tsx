    ...
    <div className="min-h-screen bg-[#1D1E26] text-white">
      ...
      <header className="bg-[#262932] border-b border-white/10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2 flex items-center gap-1 sm:gap-2 overflow-x-auto">
          <Link href="/dashboard/transactions" className="px-3 py-1.5 rounded-lg text-sm font-medium text-gray-400 hover:bg-[#1D1E26] hover:text-white transition-colors whitespace-nowrap flex items-center gap-1">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
