          ...
          <main>
            <header className="mb-8 sm:mb-12">
              <div className="flex flex-wrap items-center gap-3 mb-4">
                ...
                <span className="px-3 py-1 rounded-full bg-purple-500/10 text-purple-400 text-xs font-medium">Soroban Pro</span>
              </div>
              ...
              <div className="space-y-4 mb-6">
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-[#40B8F4]/10 text-[#40B8F4] text-xs font-medium">PERSISTENT</span>
                ...
                <div className="p-4 rounded-lg bg-green-50 border border-green-200">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-500/10 text-green-400 text-xs font-medium">TEMPORARY</span>
                ...
                <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
                  <div className="flex items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-purple-500/10 text-purple-400 text-xs font-medium">INSTANCE</span>
  ...
  "data": {                    // Event data payload
    "amount": 1000000000
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <span className="px-2 py-1 rounded bg-green-500/10 text-green-400 text-xs font-medium">CONTRACT</span>
                  <p className="text-xs text-gray-400 mt-2">
                    Events explicitly emitted by the contract code. These are the primary events for tracking business logic.
                  </p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <span className="px-2 py-1 rounded bg-[#40B8F4]/10 text-[#40B8F4] text-xs font-medium">SYSTEM</span>
                  <p className="text-xs text-gray-400 mt-2">
              ...
              <div className="p-4 rounded-lg bg-green-50 border border-green-200 mb-4">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-1 rounded bg-green-500/10 text-green-400 text-xs font-medium">TEAM+</span>
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-500/10 text-green-400 font-mono text-xs">GET</span>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    ...
                    <span className="px-2 py-1 rounded bg-[#40B8F4]/10 text-[#40B8F4] text-xs">SSE</span>
                  </div>
