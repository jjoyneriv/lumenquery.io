          ...
          <main>
            <header className="mb-8 sm:mb-12">
              <div className="flex items-center gap-2 mb-4">
                <span className="px-3 py-1 rounded-full bg-green-500/10 text-green-400 text-xs font-medium">Public Access</span>
                <span className="px-3 py-1 rounded-full bg-[#40B8F4]/10 text-[#40B8F4] text-xs font-medium">Real-Time</span>
              </div>
