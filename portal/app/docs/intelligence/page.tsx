    ...
    <div className="space-y-6">
      <div>
        ...
        <ul className="space-y-2">
          ...
          <li><a href="#tiers" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Subscription Tiers</a></li>
        </ul>
      </div>
      <div>
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Features</h3>
        <ul className="space-y-2">
          <li><a href="#live-stream" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Live Stream</a></li>
          <li><a href="#accounts" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Accounts</a></li>
          <li><a href="#watchlists" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Watchlists</a></li>
          <li><a href="#alerts" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Alerts</a></li>
          <li><a href="#trustlines" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Trustlines</a></li>
          <li><a href="#contracts" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Contracts</a></li>
        </ul>
      </div>
      <div>
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">API Reference</h3>
        <ul className="space-y-2">
          <li><a href="#api-stream" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Stream API</a></li>
          <li><a href="#api-accounts" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Accounts API</a></li>
          <li><a href="#api-watchlists" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Watchlists API</a></li>
          <li><a href="#api-alerts" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Alerts API</a></li>
          <li><a href="#api-trustlines" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Trustlines API</a></li>
        </ul>
      </div>
      <div>
          ...
          <main className="lg:col-span-3">
            ...
            <section id="introduction" className="mb-10 sm:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Real-time transaction feed with filters</p>
                </div>
                <div className="p-4 rounded-lg bg-green-50 border border-green-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Behavior analysis and risk scoring</p>
                </div>
                <div className="p-4 rounded-lg bg-orange-50 border border-orange-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Customizable notifications</p>
                </div>
              </div>
            </section>
            ...
            <section id="dashboard" className="mb-10 sm:mb-16">
              ...
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                ...
                <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence</code>.
              </p>
                ...
                <table className="w-full min-w-[400px] text-sm">
                  ...
                  <tbody className="text-xs sm:text-sm">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-400">Count of alerts requiring attention</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium">Watched Accounts</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-400">Total accounts in your watchlists</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium">Alert Configs</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-400">Active alert rule configurations</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-2 sm:py-3 px-2 sm:px-4 font-medium">TX/Hour</td>
                      <td className="py-2 sm:py-3 px-2 sm:px-4 text-gray-400">Transactions monitored per hour</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="live-stream" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Live Stream</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Monitor Stellar network transactions in real-time with powerful filtering capabilities.
                Access at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/stream</code>.
              </p>
              ...
              <div className="space-y-3">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Stream all network operations without filtering</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">XLM and asset transfers between accounts</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Manage offers and trades on the decentralized exchange</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Cross-asset payments using DEX liquidity paths</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Trustline creation, updates, and removals</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Large XLM transfers exceeding your tier threshold</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Smart contract invocations (invoke_host_function)</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Temporarily pause the stream to analyze transactions without losing new data</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Clear History</h4>
                  <p className="text-xs text-gray-400">Reset the transaction list while keeping the stream connected</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Auto-Scroll</h4>
                  <p className="text-xs text-gray-400">Automatically scrolls to new transactions; pauses when you scroll up</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Status Indicator</h4>
                  <p className="text-xs text-gray-400">Shows connection status: connecting, connected, disconnected, error</p>
                </div>
              </div>
            ...
            <section id="accounts" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Accounts</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Analyze any Stellar account or Soroban contract with comprehensive profiling.
                Access at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/accounts</code>.
              </p>
  ...
  "behaviorMetrics": {...}  // Premium only
                ...
                <table className="w-full min-w-[500px] text-sm">
                  ...
                  <tbody className="text-xs sm:text-sm">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-3 px-4 text-gray-400">Balance &ge; 10M XLM</td>
                      <td className="py-3 px-4 text-gray-400">High-value account</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4"><span className="px-2 py-1 rounded bg-blue-100 text-blue-700 text-xs">EXCHANGE</span></td>
                      <td className="py-3 px-4 text-gray-400">&gt;50 counterparties</td>
                      <td className="py-3 px-4 text-gray-400">Exchange or high-activity</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4"><span className="px-2 py-1 rounded bg-purple-100 text-purple-700 text-xs">MARKET_MAKER</span></td>
                      <td className="py-3 px-4 text-gray-400">&gt;10 trustlines</td>
                      <td className="py-3 px-4 text-gray-400">Multi-asset trading</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4"><span className="px-2 py-1 rounded bg-yellow-100 text-yellow-700 text-xs">ISSUER</span></td>
                      <td className="py-3 px-4 text-gray-400">Has issued assets</td>
                      <td className="py-3 px-4 text-gray-400">Asset issuer account</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4"><span className="px-2 py-1 rounded bg-green-100 text-green-700 text-xs">ANCHOR</span></td>
                      <td className="py-3 px-4 text-gray-400">Verified anchor</td>
                      <td className="py-3 px-4 text-gray-400">Fiat on/off-ramp</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4"><span className="px-2 py-1 rounded bg-gray-100 text-gray-700 text-xs">RETAIL</span></td>
                      <td className="py-3 px-4 text-gray-400">Payment activity</td>
                      <td className="py-3 px-4 text-gray-400">Standard user account</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Transaction frequency relative to typical accounts</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-1 text-sm">Volume Score</h4>
                  <p className="text-xs text-gray-400">Average transaction size compared to network</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-1 text-sm">Diversity Score</h4>
                  <p className="text-xs text-gray-400">Number and variety of counterparties</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-1 text-sm">Regularity Score</h4>
                  <p className="text-xs text-gray-400">Consistency of transaction patterns over time</p>
                </div>
              </div>
            </section>
            ...
            <section id="watchlists" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Watchlists</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Organize and monitor groups of accounts with custom watchlists.
                Access at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/watchlists</code>.
              </p>
      ...
      "addedAt": "2026-02-10T15:35:00Z"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
                  ...
                  <div className="text-xs text-gray-400">Solo Tier</div>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
                  <div className="text-2xl font-bold text-[#7366FF]">500</div>
                  <div className="text-xs text-gray-400">Teams Tier</div>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
            ...
            <section id="alerts" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Alerts</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Configure intelligent alerts to be notified of important on-chain events.
                Inbox at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/alerts</code>,
                configurations at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/alerts/configs</code>.
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-red-50 border border-red-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-2">Monitors large XLM transfers exceeding a threshold</p>
                ...
                <div className="p-4 rounded-lg bg-yellow-50 border border-yellow-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-2">Tracks trustline creation, removal, or updates</p>
                  <div className="text-xs text-gray-400">
                ...
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-2">Monitors operations from accounts in a watchlist</p>
                  <div className="text-xs text-gray-400">
                ...
                <div className="p-4 rounded-lg bg-indigo-50 border border-indigo-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-2">Tracks Soroban contract invocations</p>
                  <div className="text-xs text-gray-400">
                ...
                <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400 mb-2">AI-powered anomaly detection on account behavior</p>
                  <div className="text-xs text-gray-400">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200 text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-2">Informational events</p>
                </div>
                <div className="p-4 rounded-lg bg-yellow-50 border border-yellow-200 text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-2">Events needing attention</p>
                </div>
                <div className="p-4 rounded-lg bg-red-50 border border-red-200 text-center">
                  <span className="px-2 py-1 rounded bg-red-100 text-red-700 font-semibold text-xs">CRITICAL</span>
                  <p className="text-xs text-gray-400 mt-2">Urgent events</p>
                </div>
              </div>
            ...
            <section id="trustlines" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Trustlines</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Monitor trustline changes across the Stellar network.
                Access at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/trustlines</code>.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-green-50 border border-green-200 text-center">
                  ...
                  <p className="text-xs text-gray-400 mt-2">New trustline established</p>
                </div>
                <div className="p-4 rounded-lg bg-red-50 border border-red-200 text-center">
                  <span className="px-3 py-1 rounded bg-red-100 text-red-700 font-semibold text-sm">Removed</span>
                  <p className="text-xs text-gray-400 mt-2">Trustline deleted</p>
                </div>
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200 text-center">
                  <span className="px-3 py-1 rounded bg-blue-100 text-blue-700 font-semibold text-sm">Updated</span>
                  <p className="text-xs text-gray-400 mt-2">Trustline limit changed</p>
                </div>
              </div>
  ...
  "createdAt": "2026-02-13T10:30:00Z"
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
                  ...
                  <div className="text-xs text-gray-400">All changes</div>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
                  <div className="text-lg font-bold text-green-600">Created</div>
                  <div className="text-xs text-gray-400">New trustlines</div>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 text-center">
            ...
            <section id="contracts" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Contracts</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                Track Soroban smart contract activity on the Stellar network.
                Access at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/intelligence/contracts</code>.
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Track all invoke_host_function operations targeting Soroban contracts</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Function Calls</h4>
                  <p className="text-xs text-gray-400">Filter by specific function names within contracts</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Gas Usage</h4>
                  <p className="text-xs text-gray-400">Monitor gas consumption and set alerts for high-gas transactions</p>
                </div>
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <h4 className="font-semibold mb-2 text-sm">Contract Events</h4>
                  <p className="text-xs text-gray-400">Stream events emitted by contracts in real-time</p>
                </div>
              </div>
            ...
            <section id="api-stream" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Stream API</h2>

              <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 mb-4">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                  <code className="text-gray-400 text-sm">/api/intelligence/stream</code>
                </div>
                <p className="text-xs sm:text-sm text-gray-400">Server-Sent Events stream of network transactions</p>
              </div>
                ...
                <table className="w-full min-w-[500px] text-sm">
                  ...
                  <tbody className="text-xs sm:text-sm">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-3 px-4 text-gray-400">Transaction type: all, payments, offers, path_payments, trustlines, whale, contracts</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4 font-mono">value</td>
                      <td className="py-3 px-4 text-gray-400">string</td>
                      <td className="py-3 px-4 text-gray-400">Filter value (account ID or asset code)</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4 font-mono">minAmount</td>
                      <td className="py-3 px-4 text-gray-400">number</td>
                      <td className="py-3 px-4 text-gray-400">Minimum XLM amount for whale filter</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
data: {"message": "Rate limit exceeded", "retryAfter": 60}`}
            ...
            <section id="api-accounts" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Accounts API</h2>

              <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 mb-4">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                  <code className="text-gray-400 text-sm">/api/intelligence/accounts/&#123;accountId&#125;</code>
                </div>
                <p className="text-xs sm:text-sm text-gray-400">Get detailed profile for a Stellar account or contract</p>
              </div>
                ...
                <table className="w-full min-w-[400px] text-sm">
                  ...
                  <tbody className="text-xs sm:text-sm">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-3 px-4 text-gray-400">Stellar account (G...) or contract ID (C...)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
  ...
  "profile": {
    ...
    "behaviorMetrics": { ... }  // Premium only
            ...
            <section id="api-watchlists" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Watchlists API</h2>

              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/watchlists</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">List all watchlists with account counts</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Create a new watchlist</p>
                </div>

                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/watchlists/&#123;id&#125;</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">Get watchlist details</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Update watchlist name/description</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Delete a watchlist</p>
                </div>

                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-[#7366FF]/10 text-[#7366FF] font-mono text-xs">POST</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/watchlists/&#123;id&#125;/accounts</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">Add account to watchlist</p>
                </div>

                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-red-100 text-red-700 font-mono text-xs">DELETE</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/watchlists/&#123;id&#125;/accounts/&#123;accountId&#125;</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">Remove account from watchlist</p>
                </div>
              </div>
            </section>
            ...
            <section id="api-alerts" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Alerts API</h2>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/alerts</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">List alerts with optional filters (status, severity)</p>
                </div>

                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-yellow-100 text-yellow-700 font-mono text-xs">PUT</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/alerts/&#123;id&#125;</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">Mark alert as read</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Delete an alert</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/alerts/configs</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">List all alert configurations</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Create new alert configuration</p>
                </div>

                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  <div className="flex flex-wrap items-center gap-2 mb-2">
                    <span className="px-2 py-1 rounded bg-yellow-100 text-yellow-700 font-mono text-xs">PUT</span>
                    <code className="text-gray-400 text-sm">/api/intelligence/alerts/configs/&#123;id&#125;</code>
                  </div>
                  <p className="text-xs sm:text-sm text-gray-400">Update alert configuration</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">Delete alert configuration</p>
                </div>
              </div>
            </section>
            ...
            <section id="api-trustlines" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Trustlines API</h2>

              <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 mb-4">
                <div className="flex flex-wrap items-center gap-2 mb-2">
                  <span className="px-2 py-1 rounded bg-green-100 text-green-700 font-mono text-xs">GET</span>
                  <code className="text-gray-400 text-sm">/api/intelligence/trustlines</code>
                </div>
                <p className="text-xs sm:text-sm text-gray-400">Get recent trustline changes with filters</p>
              </div>
                ...
                <table className="w-full min-w-[400px] text-sm">
                  ...
                  <tbody className="text-xs sm:text-sm">
                    <tr className="border-b border-white/10">
                      ...
                      <td className="py-3 px-4 text-gray-400">string</td>
                      <td className="py-3 px-4 text-gray-400">Filter: all, created, removed</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4 font-mono">asset</td>
                      <td className="py-3 px-4 text-gray-400">string</td>
                      <td className="py-3 px-4 text-gray-400">Filter by asset code</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="py-3 px-4 font-mono">limit</td>
                      <td className="py-3 px-4 text-gray-400">number</td>
                      <td className="py-3 px-4 text-gray-400">Max results (default 50, max 100)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#7366FF] text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a href="mailto:support@lumenquery.io" className="px-4 py-2 rounded-lg bg-white text-[#7366FF] text-sm font-medium hover:bg-white/10 transition-colors text-center">
                  Contact Support
                </a>
