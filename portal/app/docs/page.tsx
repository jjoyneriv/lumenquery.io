      ...
      <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
            ...
            <p className="text-xs sm:text-sm text-gray-400">Access accounts, transactions, ledgers, and all blockchain data via REST API.</p>
          ...
          <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
            ...
            <p className="text-xs sm:text-sm text-gray-400">Deploy and invoke smart contracts, simulate transactions, query contract state.</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-gray-400 mb-4 text-sm">
            Include your API key in the <code className="mx-1 px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] border border-white/10 text-xs">X-API-Key</code> header.
          </p>
...
{`X-API-Key: lq_your_api_key_here`}
        ...
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-400 text-sm mb-4">
            <li><strong className="text-white">Create an account</strong> at <Link href="/auth/signup" className="text-[#7366FF] hover:underline">lumenquery.io/auth/signup</Link></li>
            <li><strong className="text-white">Generate an API key</strong> from your <Link href="/dashboard" className="text-[#7366FF] hover:underline">dashboard</Link></li>
            <li><strong className="text-white">Make your first request:</strong></li>
          </ol>
          <div className="bg-[#1D1E26] rounded-lg p-3 overflow-x-auto">
            <pre className="text-xs text-gray-300">
          ...
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            ...
            <div className="space-y-1 text-xs">
              <div className="flex items-center gap-2">
                ...
                <code className="text-gray-400">/accounts/{'{id}'}</code>
              </div>
              <div className="flex items-center gap-2">
                <span className="px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-mono text-[10px]">GET</span>
                <code className="text-gray-400">/accounts/{'{id}'}/transactions</code>
              </div>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            ...
            <div className="space-y-1 text-xs">
              <div className="flex items-center gap-2">
                <span className="px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-mono text-[10px]">GET</span>
                <code className="text-gray-400">/ledgers</code>
              </div>
              <div className="flex items-center gap-2">
                <span className="px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-mono text-[10px]">GET</span>
                <code className="text-gray-400">/ledgers/{'{sequence}'}</code>
              </div>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            ...
            <div className="space-y-1 text-xs">
              <div className="flex items-center gap-2">
                <span className="px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-mono text-[10px]">GET</span>
                <code className="text-gray-400">/transactions</code>
              </div>
              <div className="flex items-center gap-2">
      ...
      <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            ...
            <div className="space-y-1 text-xs">
              <code className="block text-gray-400">getHealth</code>
              <code className="block text-gray-400">getNetwork</code>
              <code className="block text-gray-400">getLatestLedger</code>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            <h3 className="font-semibold mb-2 text-sm">Transactions</h3>
            <div className="space-y-1 text-xs">
              <code className="block text-gray-400">simulateTransaction</code>
              <code className="block text-gray-400">sendTransaction</code>
              <code className="block text-gray-400">getTransaction</code>
            </div>
          </div>
          <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
            <h3 className="font-semibold mb-2 text-sm">Contract Data</h3>
            <div className="space-y-1 text-xs">
              <code className="block text-gray-400">getLedgerEntries</code>
              <code className="block text-gray-400">getEvents</code>
              <code className="block text-gray-400">getFeeStats</code>
            </div>
          </div>
        </div>
...
const server = new SorobanRpc.Server(
  ...
  { headers: { 'X-API-Key': 'lq_...' } }
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        <Link href="/docs/analytics" className="p-4 rounded-xl bg-[#262932] border border-white/10 hover:border-[#7366FF] transition-colors group">
          ...
          <p className="text-xs text-gray-400">Network metrics & charts</p>
        </Link>
        <Link href="/docs/intelligence" className="p-4 rounded-xl bg-[#262932] border border-white/10 hover:border-[#7366FF] transition-colors group">
          ...
          <p className="text-xs text-gray-400">Alerts & monitoring</p>
        </Link>
        <Link href="/docs/contracts" className="p-4 rounded-xl bg-[#262932] border border-white/10 hover:border-[#7366FF] transition-colors group">
          ...
          <p className="text-xs text-gray-400">Soroban explorer</p>
        </Link>
        <Link href="/docs/portfolio" className="p-4 rounded-xl bg-[#262932] border border-white/10 hover:border-[#7366FF] transition-colors group">
          ...
          <p className="text-xs text-gray-400">P&L & yield tracking</p>
        </Link>
      </div>
      ...
      <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#7366FF] text-white">
        ...
        <div className="flex flex-wrap gap-3">
          <a href="mailto:support@lumenquery.io" className="px-4 py-2 rounded-lg bg-white text-[#7366FF] text-sm font-medium hover:bg-white/10 transition-colors">
            Contact Support
          </a>
