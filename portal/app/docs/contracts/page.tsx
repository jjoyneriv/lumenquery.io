  ...
  const sidebarContent = (
    <div className="space-y-6">
      ...
      <div>
        ...
        <ul className="space-y-2">
          <li><a href="#decoded-calls" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Decoded Calls</a></li>
          <li><a href="#storage-viewer" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Storage Viewer</a></li>
          <li><a href="#event-stream" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Event Stream</a></li>
          <li><a href="#ai-explanations" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>AI Explanations</a></li>
        </ul>
      </div>
      <div>
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Reference</h3>
        <ul className="space-y-2">
          <li><a href="#xdr-decoding" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>XDR Decoding</a></li>
          <li><a href="#data-types" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Soroban Data Types</a></li>
          <li><a href="#api-reference" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>API Reference</a></li>
        </ul>
      </div>
      <div>
        <h3 className="text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3">Documentation</h3>
        <ul className="space-y-2">
          <li><Link href="/docs" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>API Documentation</Link></li>
          <li><Link href="/docs/analytics" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Network Analytics</Link></li>
          <li><Link href="/docs/intelligence" className="text-gray-400 hover:text-[#7366FF]" onClick={() => setSidebarOpen(false)}>Transaction Intelligence</Link></li>
        </ul>
      </div>
    </div>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <main className="lg:col-span-3">
            ...
            <section id="introduction" className="mb-10 sm:mb-16">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
                <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
                  ...
                  <p className="text-xs text-gray-400">Human-readable function calls and parameters</p>
                </div>
                <div className="p-4 rounded-lg bg-blue-50 border border-blue-200">
                  <div className="text-blue-600 text-2xl mb-2">{'{ }'}</div>
                  <h3 className="font-semibold text-sm mb-1">Storage Viewer</h3>
                  <p className="text-xs text-gray-400">Browse contract state and data</p>
                </div>
                <div className="p-4 rounded-lg bg-green-50 border border-green-200">
                  <div className="text-green-600 text-2xl mb-2">{'~>'}</div>
                  <h3 className="font-semibold text-sm mb-1">Event Stream</h3>
                  <p className="text-xs text-gray-400">Real-time contract event monitoring</p>
                </div>
                <div className="p-4 rounded-lg bg-amber-50 border border-amber-200">
                  <div className="text-amber-600 text-2xl mb-2">{'AI'}</div>
                  <h3 className="font-semibold text-sm mb-1">AI Explanations</h3>
                  <p className="text-xs text-gray-400">Plain-English contract analysis</p>
                </div>
              </div>
            </section>
            ...
            <section id="dashboard" className="mb-10 sm:mb-16">
              ...
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
                The Contracts Explorer dashboard at <code className="px-2 py-1 rounded bg-[#1D1E26] text-[#7366FF] text-xs">/contracts</code> provides
              ...
              <div className="p-4 rounded-lg bg-purple-50 border border-purple-200">
                ...
                <ol className="list-decimal list-inside space-y-1 text-sm text-gray-400">
                  ...
                  <li>Enter a contract ID in the search bar (e.g., <code className="px-1 bg-[#262932] rounded text-xs">CDLZ...XYZ</code>)</li>
            ...
            <section id="tiers" className="mb-10 sm:mb-16">
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[600px] text-sm border border-white/10 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-[#1D1E26]">
                      <th className="text-left py-3 px-4 font-semibold">Feature</th>
                      <th className="text-center py-3 px-4 font-semibold">Free</th>
                      <th className="text-center py-3 px-4 font-semibold">Developer<br/><span className="text-xs font-normal text-gray-400">$25/mo</span></th>
                      <th className="text-center py-3 px-4 font-semibold">Team<br/><span className="text-xs font-normal text-gray-400">$99/mo</span></th>
                  ...
                  <tbody>
                    ...
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
            ...
            <section id="decoded-calls" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <ul className="text-xs text-gray-400 space-y-1">
                    <li>- Function name (e.g., <code className="bg-[#262932] px-1 rounded">transfer</code>, <code className="bg-[#262932] px-1 rounded">mint</code>)</li>
              ...
              <div className="space-y-4">
                <div>
                  <p className="text-sm text-gray-400 mb-2">Raw XDR (unreadable):</p>
...
{`AAAAAgAAAADo...base64_encoded_xdr_data...AAAAAAAAAA==`}
                ...
                <div>
                  <p className="text-sm text-gray-400 mb-2">Decoded (human-readable):</p>
                  <div className="bg-[#1D1E26] rounded-lg p-4 overflow-x-auto">
...
{`{
  ...
  "timestamp": "2026-02-13T10:30:00Z"
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[500px] text-sm border border-white/10 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-[#1D1E26]">
                  ...
                  <tbody>
                    <tr className="border-t border-white/10">
                      ...
                      <td className="py-2 px-3 text-gray-400">When the call was executed</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">Function</td>
                      <td className="py-2 px-3 text-gray-400">Decoded function name</td>
                    </tr>
                    <tr className="border-t border-white/10">
                      <td className="py-2 px-3 font-medium">Caller</td>
                      <td className="py-2 px-3 text-gray-400">Source account address (truncated)</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">Parameters</td>
                      <td className="py-2 px-3 text-gray-400">Decoded input parameters</td>
                    </tr>
                    <tr className="border-t border-white/10">
                      <td className="py-2 px-3 font-medium">Status</td>
                      <td className="py-2 px-3 text-gray-400">Success (green) or Failed (red) with error code</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">Gas</td>
                      <td className="py-2 px-3 text-gray-400">Gas consumed in stroops</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-400">
                <li><strong>Function name</strong> - Filter by specific function (e.g., <code className="px-1 bg-[#1D1E26] rounded text-xs">transfer</code>)</li>
                ...
                <table className="w-full min-w-[500px] text-sm border border-white/10 rounded-lg overflow-hidden">
                  ...
                  <tbody>
                    <tr className="border-t border-white/10">
                      ...
                      <td className="py-2 px-3 text-gray-400">Decoded storage key (e.g., <code className="bg-[#1D1E26] px-1 rounded text-xs">Balance:GABC...XYZ</code>)</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">Type</td>
                      <td className="py-2 px-3 text-gray-400">Storage type badge (Persistent/Temporary/Instance)</td>
                    </tr>
                    <tr className="border-t border-white/10">
                      <td className="py-2 px-3 font-medium">Value</td>
                      <td className="py-2 px-3 text-gray-400">Decoded value with type information</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">TTL</td>
                      <td className="py-2 px-3 text-gray-400">Time-to-live (ledgers remaining for temporary storage)</td>
                    </tr>
                    <tr className="border-t border-white/10">
                      <td className="py-2 px-3 font-medium">Last Modified</td>
                      <td className="py-2 px-3 text-gray-400">Ledger sequence when value was last changed</td>
                    </tr>
                  </tbody>
                </table>
              </div>
...
{`{
  ...
  "data": {                    // Event data payload
    "amount": 1000000000
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-gray-400 mb-6">
                ...
                <table className="w-full min-w-[500px] text-sm border border-white/10 rounded-lg overflow-hidden">
                  ...
                  <tbody>
                    <tr className="border-t border-white/10">
                      ...
                      <td className="py-2 px-3 text-gray-400 text-xs">[&quot;transfer&quot;, from, to]</td>
                      <td className="py-2 px-3 text-gray-400">Token transfers</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">approve</td>
                      <td className="py-2 px-3 text-gray-400 text-xs">[&quot;approve&quot;, owner, spender]</td>
                      <td className="py-2 px-3 text-gray-400">Allowance approvals</td>
                    </tr>
                    <tr className="border-t border-white/10">
                      <td className="py-2 px-3 font-medium">mint</td>
                      <td className="py-2 px-3 text-gray-400 text-xs">[&quot;mint&quot;, to]</td>
                      <td className="py-2 px-3 text-gray-400">Token minting</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
                      <td className="py-2 px-3 font-medium">burn</td>
                      <td className="py-2 px-3 text-gray-400 text-xs">[&quot;burn&quot;, from]</td>
                      <td className="py-2 px-3 text-gray-400">Token burning</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section id="ai-explanations" className="mb-10 sm:mb-16">
              ...
              <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10 mb-6">
  ...
  "amount": 1000000000
              ...
              <div className="p-4 rounded-lg bg-amber-50 border border-amber-200">
                ...
                <p className="text-sm text-gray-400 mt-2">
                  <strong>Details:</strong> The <code className="px-1 bg-[#262932] rounded text-xs">transfer</code> function
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[300px] text-sm border border-white/10 rounded-lg overflow-hidden">
                  <thead>
                    <tr className="bg-[#1D1E26]">
                  ...
                  <tbody>
                    <tr className="border-t border-white/10">
                      ...
                      <td className="py-2 px-3 text-gray-400">Not available</td>
                    </tr>
                    <tr className="border-t border-white/10 bg-[#1D1E26]/50">
            ...
            <section id="xdr-decoding" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">XDR Decoding</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 mb-6">
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">TransactionEnvelope</div>
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">TransactionResult</div>
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">TransactionMeta</div>
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">LedgerEntry</div>
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">ContractEvent</div>
                <div className="p-2 rounded bg-[#1D1E26] text-xs font-mono">SCVal (Soroban Values)</div>
              </div>
  ...
  "balances": {
    ...
    "GDEF...UVW": 500000000
            ...
            <section id="data-types" className="mb-10 sm:mb-16">
              <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 pb-2 border-b border-white/10">Soroban Data Types</h2>
              <p className="text-gray-400 mb-4 text-sm sm:text-base">
            ...
            <section id="api-reference" className="mb-10 sm:mb-16">
              ...
              <div className="space-y-6">
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400 mb-3">Search for contracts by ID, name, or deployer</p>
                  <div className="text-xs">
                    <span className="text-gray-400">Query params:</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">q</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">limit</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">offset</code>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Get contract details including metadata and statistics</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400 mb-3">Get decoded call history with pagination</p>
                  <div className="text-xs">
                    <span className="text-gray-400">Query params:</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">function</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">caller</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">status</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">from</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">to</code>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400 mb-3">Get decoded contract storage entries</p>
                  <div className="text-xs">
                    <span className="text-gray-400">Query params:</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">type</code>
                    <span className="text-gray-400">(persistent|temporary|instance)</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400 mb-3">Get decoded contract events</p>
                  <div className="text-xs">
                    <span className="text-gray-400">Query params:</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">type</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">topic</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">from_ledger</code>
                    <code className="ml-2 px-1 bg-[#262932] rounded">to_ledger</code>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Real-time event stream via Server-Sent Events (Team+ only)</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Get AI-powered explanation for a contract call</p>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400 mb-3">Export contract data in CSV or JSON format</p>
                  <div className="text-xs">
                    <span className="text-gray-400">Query params:</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">format</code>
                    <span className="text-gray-400">(csv|json)</span>
                    <code className="ml-2 px-1 bg-[#262932] rounded">type</code>
                    <span className="text-gray-400">(calls|storage|events)</span>
                  </div>
                </div>
                ...
                <div className="p-4 rounded-lg bg-[#1D1E26] border border-white/10">
                  ...
                  <p className="text-xs text-gray-400">Get contract analytics including gas usage, call frequency, and error rates</p>
                </div>
              </div>
            </section>
