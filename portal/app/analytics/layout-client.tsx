    ...
    <div className="min-h-screen bg-[#1D1E26] text-white">
      ...
      <header className="bg-[#1D1E26] border-b border-white/10">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2 flex items-center gap-1 sm:gap-2 overflow-x-auto">
          ...
          <Link href="/analytics" className="px-3 py-1.5 rounded-lg text-sm font-medium text-[#7366FF] bg-[#7366FF]/10 hover:bg-[#7366FF]/20 transition-colors whitespace-nowrap">
            Analytics
          </Link>
