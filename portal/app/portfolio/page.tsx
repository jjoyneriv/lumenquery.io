...
export default function PortfolioPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Tier Info Card */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
        ...
        <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6">Your Portfolios</h2>
            ...
            {loading ? (
              <div className="text-center py-12">
                ...
                <p className="mt-4 text-gray-400">Loading portfolios...</p>
              </div>
            ) : error ? (
              <div className="text-center py-12">
                ...
                {portfolios.map((portfolio) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block p-6 rounded-xl bg-[#1D1E26] border border-white/10 hover:border-indigo-300 hover:shadow-md transition-all"
                    >
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-xs sm:text-sm text-gray-400">Track multiple accounts in one view</p>
        </div>
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-xs sm:text-sm text-gray-400">FIFO cost basis calculation</p>
        </div>
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-xs sm:text-sm text-gray-400">Staking, LP, and DeFi rewards</p>
        </div>
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-xs sm:text-sm text-gray-400">Issuer authorization analysis</p>
        </div>
        <div className="p-4 sm:p-6 rounded-xl sm:rounded-2xl bg-[#262932] border border-white/10">
          ...
          <p className="text-xs sm:text-sm text-gray-400">Soroban smart contracts</p>
        </div>
